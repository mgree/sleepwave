...
{
	if (region.ae.Q === region.al.Q)
	{
		return 'on line ' + region.ae.Q;
	}
	return 'on lines ' + region.ae.Q + ' through ' + region.al.Q;
}
...
var author$project$Main$ClockAndTimeLeft = 0;
...
var author$project$Main$initConfig = function (settings) {
	return {
		H: author$project$Main$millisToHMSShort(settings.l),
...
var author$project$Main$init = function (localStorageSettings) {
	return _Utils_Tuple2(
		{
			c: author$project$Main$initConfig(
				function () {
...
var author$project$Main$ConfigNotificationPermission = function (a) {
	return {$: 16, a: a};
};
...
var author$project$Main$notificationPermission = _Platform_incomingPort('notificationPermission', elm$json$Json$Decode$value);
...
var elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aD: processes, aO: taggers};
	});
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Main$notificationPermission(
				function (json) {
					return author$project$Main$ConfigNotificationPermission(
						A2(
							elm$core$Result$withDefault,
							false,
							A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$bool, json)));
				})
			]));
};
var author$project$Main$Began = {$: 0};
var author$project$Main$BetweenWaves = {$: 2};
var author$project$Main$CryingStarted = {$: 2};
var author$project$Main$CryingStopped = {$: 3};
var author$project$Main$Ended = {$: 1};
var author$project$Main$GracePeriod = function (a) {
	return {$: 4, a: a};
};
var author$project$Main$Quiescent = {$: 1};
var author$project$Main$Waved = function (a) {
	return {$: 5, a: a};
};
var author$project$Main$Waving = {$: 3};
var author$project$Main$formatHour = F2(
	function (config, baseHour) {
		var hourNum = config.m ? A2(elm$core$Basics$modBy, 12, baseHour) : baseHour;
...
var author$project$Main$clockTime = F2(
	function (config, time) {
		var second = author$project$Main$twoDigitInt(
			A2(elm$time$Time$toSecond, config.w, time));
		var minute = author$project$Main$twoDigitInt(
			A2(elm$time$Time$toMinute, config.w, time));
		var baseHour = A2(elm$time$Time$toHour, config.w, time);
		var hour = A2(author$project$Main$formatHour, config, baseHour);
		var ampm = config.m ? ((baseHour >= 12) ? 'pm' : 'am') : '';
		return hour + (':' + (minute + (':' + (second + ampm))));
	});
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$notify = _Platform_outgoingPort('notify', elm$json$Json$Encode$string);
...
var author$project$Main$date = F2(
	function (config, time) {
		var year = elm$core$String$fromInt(
			A2(elm$time$Time$toYear, config.w, time));
		var month = author$project$Main$toTwoDigitMonth(
			A2(elm$time$Time$toMonth, config.w, time));
		var day = author$project$Main$twoDigitInt(
			A2(elm$time$Time$toDay, config.w, time));
...
var author$project$Main$setNotifyOnWave = F2(
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aj: col, d: s0.d, e: s0.e, b: offset, aJ: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aJ, s.aj, s);
	};
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aj: col, aV: contextStack, aB: problem, aJ: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.aJ, s.aj, x, s.d));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.aJ, s.aj, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aj: newCol, d: s.d, e: s.e, b: newOffset, aJ: newRow, a: s.a});
	};
};
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aj: col, aB: problem, aJ: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.aJ, p.aj, p.aB);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{aj: 1, d: _List_Nil, e: 1, b: 0, aJ: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'waveTime',
				elm$json$Json$Encode$int(settings.k)),
				_Utils_Tuple2(
				'graceTime',
				elm$json$Json$Encode$int(settings.l)),
				_Utils_Tuple2(
				'twelveHour',
...
var author$project$Main$updateNotificationPermission = F2(
		...
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c: A2(author$project$Main$setZone, newZone, model.c),
							f: newTime
						}),
			...
			case 9:
				return _Utils_Tuple2(
					model,
					function () {
						var dateNow = A2(author$project$Main$date, model.c, model.f);
						var timeNow = A2(author$project$Main$clockTime, model.c, model.f);
						var filename = 'sleep-' + (dateNow + ('-' + (timeNow + '.csv')));
						return A3(
							elm$file$File$Download$string,
							filename,
							'text/csv',
							A2(author$project$Main$logToCSV, model.c, model.t));
					}());
			case 10:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c: A2(author$project$Main$updateWaveTime, newWaveTime, model.c)
						}),
					elm$core$Platform$Cmd$none);
			case 11:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c: A2(author$project$Main$updateGraceTime, newGraceTime, model.c)
						}),
					elm$core$Platform$Cmd$none);
			case 16:
				var newNotificationPermission = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c: A2(author$project$Main$updateNotificationPermission, newNotificationPermission, model.c)
						}),
					elm$core$Platform$Cmd$none);
			case 12:
				var config = model.c;
				var _n1 = author$project$Main$tryHMSToMillis(config.I);
				if (_n1.$ === 1) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var _new = _n1.a;
					return A2(
						...
						_Utils_update(
							config,
							{
								I: author$project$Main$millisToHMSShort(_new),
								k: _new
							}),
						model);
				}
			case 13:
				var config = model.c;
				var _n2 = author$project$Main$tryHMSToMillis(config.H);
				if (_n2.$ === 1) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var _new = _n2.a;
			...
			case 14:
				...
				return A2(
					author$project$Main$updateAndSaveConfig,
					A2(author$project$Main$setTwelveHour, newTwelveHour, model.c),
					model);
			case 15:
				var newNotifyOnWave = msg.a;
				return A2(
					author$project$Main$updateAndSaveConfig,
					A2(author$project$Main$setNotifyOnWave, newNotifyOnWave, model.c),
					model);
			default:
				return A2(
					author$project$Main$updateAndSaveConfig,
					author$project$Main$cycleRemainingMode(model.c),
					model);
		}
	});
...
var author$project$Main$Begin = {$: 2};
var author$project$Main$End = {$: 3};
var author$project$Main$EndWave = {$: 5};
...
var author$project$Main$viewClock = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				A2(author$project$Main$clockTime, model.c, model.f))
			]));
};
var author$project$Main$ConfigSetGraceTime = {$: 13};
var author$project$Main$ConfigSetNotifyOnWave = function (a) {
	return {$: 15, a: a};
};
			...
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$checked(config.m),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$for('config-notify-on-wave')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Notify me when it\'s time for a visit')
							]))
					]))
			]));
};
...
var author$project$Main$countWaves = function (model) {
	return elm$core$List$length(
		A2(elm$core$List$filter, author$project$Main$isWaved, model.t));
};
				...
				_List_fromArray(
					[
						...
						author$project$Main$millisToHMSLong(
							A2(author$project$Main$timeDifference, model.f, model.E) + model.R))
					])),
				A2(
...
var author$project$Main$computeTimeLeft = F3(
	function (model, timeStarted, duration) {
		var elapsed = A2(author$project$Main$timeDifference, model.f, timeStarted);
		var remaining = duration - elapsed;
		var targetTime = elm$time$Time$millisToPosix(
			elm$time$Time$posixToMillis(model.f) + remaining);
		return {Z: remaining, U: targetTime};
	});
var author$project$Main$ConfigCycleRemaining = {$: 17};
var author$project$Main$targetTimeClock = F2(
	function (config, _n0) {
		var remaining = _n0.Z;
		var targetTime = _n0.U;
		return A2(
			elm$html$Html$h1,
			_List_fromArray(
				[
...
var author$project$Main$remainingTime = F2(
	function (model, computed) {
		...
		var clock = A2(author$project$Main$targetTimeClock, model.c, computed);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
		...
		function () {
			...
			switch (_n0.$) {
				...
				case 1:
					return _List_Nil;
				case 2:
					var computed = A3(author$project$Main$computeTimeLeft, model, model.j, model.c.k);
					return _List_fromArray(
						[
				...
				default:
					var originalTimeEntered = _n0.a;
					var computed = A3(author$project$Main$computeTimeLeft, model, originalTimeEntered, model.c.k);
					return _List_fromArray(
						[
							A2(
							elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									A3(author$project$Main$computeTimeLeft, model, model.j, model.c.l),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(elm$html$Html$Lazy$lazy2, author$project$Main$viewLog, model.c, model.t),
				A2(
				elm$html$Html$Lazy$lazy,
				A2(
...
var author$project$Main$main = elm$browser$Browser$element(
	{a$: author$project$Main$init, a6: author$project$Main$subscriptions, a8: author$project$Main$update, ba: author$project$Main$view});
